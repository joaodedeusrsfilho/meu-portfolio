            ...
            <div className="containerHardSkills">
                ...
                <div className='div1'>
                    <div className="div1_1">
                        <img src="./imagens/hardskills/api.png" alt="logoJavaScript" />

                        <p>Conhecimento em API FETCH e API AXIOS, a primeira é uma interface JavaScript moderna para fazer requisições HTTP/HTTPS de forma assíncrona. A segunda é uma escolha popular para lidar com a comunicação de dados entre o frontend e o backend em aplicações web.</p>
                    </div>
                    <div className="div1_1">
